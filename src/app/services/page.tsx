...
export default function ServicesPage() {
  ...
  return (
   <div className="min-h-screen bg-gradient-to-b from-gray-800 via-gray-900 to-black flex items-center justify-center p-10 px-6 py-16 mt-20 overflow-hidden">
      <div ref={containerRef} className="relative w-[300px] h-[300px] md:w-[18.75rem] md:h-[18.75rem] flex items-center justify-center">
        {/* Main Services */}
         <div className="absolute w-[120px] h-[120px] md:w-[7.5rem] md:h-[7.5rem] bg-yellow-500 rounded-full shadow-[0px_0px_20px_10px_rgba(255,215,0,0.7)]"></div>
        
        {services.map((service, index) => (
          <div
            key={index}
            className={`cards absolute w-[120px] h-[120px] md:w-[7.5rem] md:h-[7.5rem] bg-white-700 rounded-full flex flex-col items-center justify-center shadow-lg p-4 border border-yellow-400 hover:shadow-[0px_0px_15px_7px_rgba(255,215,0,0.7)] transition duration-300`}
            style={{
