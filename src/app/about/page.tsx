...
export default function About() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white to-yellow-50 px-6 py-16">
      <div className="max-w-6xl mx-auto">
        <div className="bg-white shadow-xl rounded-3xl p-10 flex flex-col md:flex-row items-center gap-10 mb-16 fade-in">
          {/* Avatar */}
          <div className="md:w-1/3 flex justify-center">
            <img
              src={Image.src}
              alt="Avatar"
              className="w-80 h-80 object-cover rounded-full border-4 border-yellow-500 shadow-md"
            />
          </div>
          {/* Info */}
          <div className="md:w-2/3 text-center md:text-left">
            <h1 className="text-4xl font-bold text-yellow-600 mb-4">Hello!</h1>
            ...
            <p className="italic text-yellow-700 font-semibold">"Never stop learning – Never stop improving."</p>
          </div>
        </div>
        {/* Certification */}
        <div className="fade-in">
          <h2 className="text-3xl font-bold text-gray-800 mb-8 text-center">📜 Certification & Awards</h2>
